...
class ForumUserTestSuite {
    ...
    @Test
    void testGetLocationOffFriends() {
        // Given
        ...
        //      user7:  "Washington"
        //      user10: "Miami"
        Assertions.assertEquals(3,user1.getLocationsOffFriends().size());
        Assertions.assertTrue(user1.getLocationsOffFriends().contains("Key West"));
        Assertions.assertTrue(user1.getLocationsOffFriends().contains("Washington"));
        Assertions.assertTrue(user1.getLocationsOffFriends().contains("Miami"));
        Assertions.assertFalse(user1.getLocationsOffFriends().contains("Orlando"));
    }
    @Test
    void testGetLocationOffFriendsOffFriends() {
        //Given
        //Create users
        ForumUser user1 = new ForumUser("alan01", "Alan Kosovsky", "Washington");
        ForumUser user2 = new ForumUser("ethanreard", "Ethan Reard", "Miami");
        ...
        Assertions.assertEquals(3,user1.getLocationsOffFriendsOffFriends().size());
        Assertions.assertTrue(user1.getLocationsOffFriendsOffFriends().contains("Key West"));
        Assertions.assertTrue(user1.getLocationsOffFriendsOffFriends().contains("Washington"));
        Assertions.assertTrue(user1.getLocationsOffFriendsOffFriends().contains("Miami"));
        Assertions.assertFalse(user1.getLocationsOffFriendsOffFriends().contains("Orlando"));
